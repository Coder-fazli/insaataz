...
namespace Mhaciyev\DependencyContainer;
...
class DependencyContainer extends Field
{
    ...
    public function dependsOn($attributes,$value, $mixin)
    {
        $this->withMeta([
            'dependencies' => array_merge($this->meta['dependencies'], [
                $this->getFieldLayout($attributes,$value),
            ]),
        ]);
    ...
    {
        $this->withMeta(['routeName' => $string]);
        return $this;
    }

//    public function dependsOn($field, $value,$attributes, $mixin)
//    {
