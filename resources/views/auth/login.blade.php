...
@section('content')
    <main>
        <section class="login" style="padding: 60px 0; background: #f8f9fa; min-height: 80vh;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 col-lg-5">
                        <div class="login-card" style="background: #fff; padding: 40px; border-radius: 16px; box-shadow: 0 5px 25px rgba(0,0,0,0.1);">
                            <h2 style="text-align: center; margin-bottom: 30px; color: #2b5797; font-weight: 600;">{{__('site.login')}}</h2>

                            <form action="{{route('profile.submitLoginForm')}}" method="post">
                                @csrf
                                ...
                                <div class="form-group" style="margin-bottom: 30px;">
                                    <label for="password" style="font-size: 14px; font-weight: 500; color: #333; margin-bottom: 8px; display: block;">{{__('auth.password')}}</label>
                                    <input type="password"
                                           name="password"
                                           id="password"
                                ...
                                <div style="text-align: center;">
                                    <a href="{{route('profile.forget_password')}}" style="color: #2b5797; text-decoration: none; font-size: 14px; transition: all 0.3s ease;" onmouseover="this.style.textDecoration='underline';" onmouseout="this.style.textDecoration='none';">
                                        {{__('site.did_you_forget_password')}}
                                    </a>
                                </div>
                            </form>
                        </div>
