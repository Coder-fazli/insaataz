...
.orel-logo-showcase img {
    max-width: 180px;
    margin-bottom: 24px;
    border-radius: 16px;
}

.orel-company-tagline {
    font-size: 16px;
    color: #94a3b8;
    font-weight: 500;
}

.orel-company-tagline strong {
    color: #ffffff;
    display: block;
    font-size: 22px;
    margin-bottom: 4px;
...
.orel-stat-box:last-child::after {
    display: none;
}

.orel-stat-box .orel-number {
    font-size: 48px;
    font-weight: 800;
    background: linear-gradient(135deg, #60a5fa 0%, #3b82f6 100%);
    -webkit-background-clip: text;
    ...
    <div class="container">
        <div class="orel-hero-content">
            ...
            <div class="orel-hero-visual">
                <div class="orel-visual-card">
                    <div class="orel-logo-showcase">
                        <img src="{{asset('storage/'.$about->image)}}" alt="OREL İnşaat">
                        <div class="orel-company-tagline">
                            <strong>OREL İNŞAAT MMC</strong>
                            Mühəndislik Həlləri
                        </div>
                    </div>
                </div>
...
<!-- Stats Banner -->
<section class="orel-stats-banner">
    <div class="container">
        <div class="orel-stats-grid">
            <div class="orel-stat-box">
                <div class="orel-number">25+</div>
                <div class="orel-label">İllik Təcrübə</div>
            </div>
            <div class="orel-stat-box">
                <div class="orel-number">1000+</div>
                <div class="orel-label">Tamamlanmış Layihə</div>
            </div>
            <div class="orel-stat-box">
                <div class="orel-number">50+</div>
                <div class="orel-label">Dünya Brendləri</div>
            </div>
            <div class="orel-stat-box">
                <div class="orel-number">24/7</div>
                <div class="orel-label">Texniki Dəstək</div>
            </div>
        </div>
    </div>
</section>
